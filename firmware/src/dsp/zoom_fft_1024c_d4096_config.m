...
function zoom_fft_1024c_d4096_config(this_block)

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('zoom_fft_1024c_d4096_ip_struct');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/zoom_fft_1024c_d4096_ip_struct.vhd');
