...
function ospfb_2x_4096c_8i_16o_config(this_block)

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('ospfb_2x_4096c_8i_16o_ip_struct');
  ...
  this_block.addFile('dsp/ospfb_2x_4096c_8i_16o_ip_struct.vhd');
