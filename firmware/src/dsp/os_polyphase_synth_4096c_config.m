...
function os_polyphase_synth_4096c_config(this_block)

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('os_polyphase_synth_4096c_ip_struct');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('dsp/os_polyphase_synth_4096c_ip_struct.vhd');
