...
set_property -dict [list CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ $AXI_CLK_MHZ] [get_bd_cells mpsoc]
...
set_property -dict [list CONFIG.Axiclk_Freq $axi_clk_mhz] [get_bd_cells usp_rf_data_converter_0]
# Set block diagram output clock port rate
set_property -dict [list CONFIG.FREQ_HZ $axi_clk_hz] [get_bd_ports pl_sys_clk]
